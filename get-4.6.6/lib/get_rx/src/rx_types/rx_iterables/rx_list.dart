...
class RxList<E> extends ListMixin<E> with NotifyManager<List<E>>, RxObjectMixin<List<E>> implements RxInterface<List<E>> {
  ...
  void Function(int idx, E e)? onGet;
  @override
  E operator [](int index) {
    onGet?.call(index, value[index]);
    return value[index];
  }
